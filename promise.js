...
//     console.log('Año inválido. Por favor ingrese un año válido.');
//   } else if (age >= 18 && age < 49) {
//     console.log(`Usted tiene ${age} años y puede ingresar a la fiesta.`);
//     console.log('El cover de la fiesta es de $20.000 pesos.');
//   } else if (age >= 49) {
//     console.log(`Usted tiene ${age} años y puede ingresar a la fiesta.`);
//     console.log('No tiene que pagar cover y se le entregará un obsequio de media botella de aguardiente o media botella de ron.');
//   } else {
//     console.log(`Lo siento, usted tiene ${age} años y no puede ingresar a la fiesta.`);
//   }
// })
...
function verificarEdad() {
  return new Promise((resolve, reject) => {
    ...
    //   } else if (yearOfBirth == isNaN && currentYear == isNaN ) {
    //     reject('Por favor ingrese solo numeros.');
      } else if (age >= 18 && age < 49) {
